...
###   Notes
###
###   Script Use - Exchange Online - List all mailboxes to which a user or email enabled security group has Send As Access
###
...
Get-Mailbox -ResultSize Unlimited | Get-RecipientPermission -Trustee $AliasOfMailboxOrGroup